        ...
        <div className="tutors">
          ...
          <div className="tutor-cards">
            <div className="card">
              ...
              <button type="button" class="btn btn-primary tutor-btn">Contact</button>
            </div>
          ...
          <h4>Pending</h4>
            <div className="pending-card">
              ...
              <div className="pending-card-inner">
                <button type="button" class="btn btn-danger pending-btn">Reject</button>
                <button type="button" class="btn btn-success pending-btn">Accept</button>
              </div>
            </div>
        </div>
      </div>
